...
<template>
  <List>
    <Open ref="open" target="float">
      <Item class="text-center capitalize" clickable down>
        <template #label>
          <div ml-4>
        ...
        <List>
          ...
          <Item>
            <div w-270px flex flex-wrap p-1 text-sm>
              ...
              >
                <div
                  class="clickable truncate rounded px-1 py-3 text-center capitalize ring-neutral-500"
